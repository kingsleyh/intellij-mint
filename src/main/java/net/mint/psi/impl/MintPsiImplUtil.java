...
import net.mint.psi.MintElementFactory;
import net.mint.psi.MintIdentifier;
import net.mint.psi.MintProperName;

import java.util.Optional;
import java.util.function.BiFunction;

import static net.mint.psi.MintElementTypes.IDENTIFIER;
import static net.mint.psi.MintElementTypes.PROPER_NAME;

public class MintPsiImplUtil {
    public static String getName(MintProperName element) {
        return element.getText();
    }

    public static PsiElement setName(MintProperName element, String newName) {
...
//                .ifPresent(e -> Messages.showWarningDialog(element.getProject(), "Unfortunately, functionality of renaming module names has not been implemented yet.", "It's not implemented yet"));
        return setName(element, PROPER_NAME, MintElementFactory::createProperName, newName);
    }

    public static String getName(MintIdentifier element) {
        return element.getText();
    }

    public static PsiElement setName(MintIdentifier element, String newName) {
        return setName(element, IDENTIFIER, MintElementFactory::createIdentifier, newName);
    }
    ...
    public static PsiElement getNameIdentifier(MintIdentifier element) {
    ...
    public static PsiElement getNameIdentifier(MintProperName element) {
        ASTNode node = element.getNode();
        if (node != null) {
            return node.getPsi();
        } else {
